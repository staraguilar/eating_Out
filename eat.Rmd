...
In conclusion the data suggest that there is a difference in the frequency, and the percentage of the routes between the black and the white races. The data indicated that there is a statistically significant difference in the data between the two races. The graphical and  numerical results, both indicate that the white race eats out at a higher frequency and percentage than the black and other races. The critical P-value showed that the frequency of eating out is the difference between the white and black races.Therefore, the alternative hypothesis is the correct conclusion.
